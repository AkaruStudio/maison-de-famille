...
```js
{
  header: {
    ...
    title: 'Nous recherchons de nouveaux agents'
  },
  card: {
    title: 'Postulez dès maintenant',
    content: 'Vous souhaitez rejoindre notre nouvelle aventure, contactez-nous et prenons rendez-vous ensemble !'
  },
  blocks: [{
    type: 'text',
    datas: {
